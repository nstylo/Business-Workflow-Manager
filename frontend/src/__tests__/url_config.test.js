...
it('should set the correct url on hostname "***REMOVED***.ml"', () => {
  window.location = { hostname: '***REMOVED***.ml' };
...
it('should set the correct url on hostname "***REMOVED***.ga"', () => {
  window.location = { hostname: '***REMOVED***.ga' };
